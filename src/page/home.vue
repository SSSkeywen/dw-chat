                ...
                <li v-for="(item, index) in mesageList" :key="index">
                  <div class="chat_message_text" v-if="!item.isMe">
                    ...
                    <div class="text_content_box">
                      <div class="chai_text_data">
                        <div class="imgContent">
                          <img v-if="item.MsgType=='2'" :src="'/tpdwt_web/chat/getFile.html?filePath='+item.localPicUrl" alt="" >
                          <div v-else-if="item.MsgType=='5'" @click="audioPlay">
                            <!-- <span>yinyue</span> -->
...
export default {
  components: {
    Personal,MyCard,Preview,Binding,comeToNothing
  },
  data() {
      return {
        isMeImgPt:'',
    ...
    methods: {
          ...
          this.messageLx({
            ...
            successCallback: () => {
              ...
              for(let i = 0; i < this.clientListData.length; i ++){
                ...
                for(let j = 0; j < this.$store.getters.messageNoDataList.length; j ++){
                  if(this.clientListData[i].OPENID == this.$store.getters.messageNoDataList[j].MSGFROM) {
                    this.clientListData[i].UNREADSUM = this.$store.getters.messageNoDataList[j].UNREADSUM
                    this.clientListData[i].MSGCONTENT = this.$store.getters.messageNoDataList[j].MSGCONTENT
                    this.clientListData[i].SENDTIME = this.$store.getters.messageNoDataList[j].SENDTIME
                  }
                }
                // console.log(this.clientListData[i].SENDTIME)
                if (this.clientListData[i].SENDTIME != '' && this.clientListData[i].SENDTIME != undefined && this.clientListData[i].SENDTIME != null){
                  let arrNumberData = this.clientListData[i].SENDTIME.split(' ')[1].split(':')
                  let arrNumberDataTwo = this.clientListData[i].SENDTIME.split(' ')[0].split('-')
                  // console.log(arrNumberData[0] + '-' + arrNumberData[1] + '-' + arrNumberData[2] + '-' + arrNumberDataTwo[2])
                  this.clientListData[i].arrNumber = arrNumberDataTwo[0] * 12 * 30 * 24 * 3600 + arrNumberDataTwo[1] * 30 * 24 * 3600 + arrNumberDataTwo[2] * 24 * 3600 + arrNumberData[0]  * 3600 + arrNumberData[1] * 60 + arrNumberData[2]
                  //  console.log(this.clientListData[i].SENDTIME)
              ...
              successCallback: () => {
                ...
                //   }
                  ...
                  if(this.userTsrL.fromType == 1){
                    ...
                    if (this.$store.getters.nowChat != '' && this.$store.getters.nowChat != undefined){
                  ...
                  if (this.$store.getters.chatData != '' && this.$store.getters.chatData != undefined && this.$store.getters.chatData != null){
                  ...
                  for (let i = 0; i < this.clientListData.length; i ++){
                    ...
                    // if(this.userTsrL.fromType == 1){
                      if (this.clientListData[i].OPENID == this.nowOpenIdData && this.clientListData[i].PHONENO == this.nowPhoneNo){
      ...
      judge() {
        ...
        if (userTsrL.TSR_SESSION.tsrposition == 'TSR' || userTsrL.TSR_SESSION.tsrposition == 'CSR' || userTsrL.TSR_SESSION.tsrposition == 'CSL'){
          this.isDisabelStar = false
          this.isSelectName = false
        }else {
          this.isSelectName = true
        }
        if (userTsrL.TSR_SESSION.tsrposition == 'TSR' || userTsrL.TSR_SESSION.tsrposition == 'CSR' || userTsrL.TSR_SESSION.tsrposition == 'TL' || userTsrL.TSR_SESSION.tsrposition == 'CSL'){
          this.isJudge = true
          this.isDisabelStar = false
        }else{
          this.isJudge = false
      ...
      openConversation() {
        ...
        this.updataChat({
          ...
          successCallback: (result) => {
            ...
            this.get_message_reply('/tpdwt_web/chat/getMessage1.html', this.nowOpenIdData, this.userTsrL.TSR_SESSION.tsrno);
            // this.get_message_reply('/tpdwt_web/chat/getMessage.html', this.nowOpenIdData, this.userTsrL.TSR_SESSION.tsrno, '1', '');
					},
					failCallback: () => {
      ...
      openWindow() {
        ...
        this.clientList({
          starNumData,
            ...
            if (userTsr.TSR_SESSION.tsrOpenid == '' || userTsr.TSR_SESSION.tsrOpenid == undefined || userTsr.TSR_SESSION.tsrOpenid == null ){
      ...
      //  }
        ...
        // console.log(this.clientListData[index])
        if (this.clientListData[index].OPENID != '' && this.clientListData[index].OPENID != undefined && this.clientListData[index].OPENID != null &&( userTsrL.TSR_SESSION.tsrposition == 'TSR' || userTsrL.TSR_SESSION.tsrposition == 'CSR')){
          // console.log(this.clientListData[index])
          this.isDisabelStar = false
        ...
        if (index == '0'){
          // this.$refs.personalOn.perSelectTwo(true, true)
          if (this.clientListData[index].OPENID != '' && this.clientListData[index].OPENID != undefined && this.clientListData[index].OPENID != null &&( userTsrL.TSR_SESSION.tsrposition == 'TSR' || userTsrL.TSR_SESSION.tsrposition == 'CSR' || userTsrL.TSR_SESSION.tsrposition == 'TL' || userTsrL.TSR_SESSION.tsrposition == 'UM')){
          // console.log(this.clientListData[index])
            this.isDisabelStar = false
            this.isDisabel = false
            this.previewDisabel = false
        ...
        if (this.clientListData[index].PHONENO != '' && this.clientListData[index].PHONENO != undefined && this.clientListData[index].PHONENO != null &&( userTsrL.TSR_SESSION.tsrposition == 'TSR' || userTsrL.TSR_SESSION.tsrposition == 'CSR' || userTsrL.TSR_SESSION.tsrposition == 'TL')){
        ...
        if (this.clientListData[index].OPENID != '' && this.clientListData[index].OPENID != undefined && this.clientListData[index].OPENID != null){
          // console.log(this.clientListData[index])
          // this.isDisabelStar = false
          // this.isDisabel = false
          // this.previewDisabel = false
          if (this.clientListData[index].PHONENO != '' && this.clientListData[index].PHONENO != undefined && this.clientListData[index].PHONENO != null){
        ...
        this.clientListEecord({
          ...
          successCallback: () => {
            ...
            for (let i = 0; i < this.mesageList.length; i ++){
              ...
              if (this.mesageList[i].ToUserName == this.clientListData[index].OPENID){
                this.mesageList[i].isMe = true
              }
              if (this.mesageList[i].ToUserName == this.clientListData[index].PHONENO){
                this.mesageList[i].isMe = true
              }
            }
            }
                    ...
                    // this.chatRecordList.push(messages)
                     ...
                     if (messages != undefined && messages != '' && messages != null){
                          for(let i = 0;i < messages.length; i ++){
                            if (messages[i].FromUserName == this.nowOpenIdData || messages[i].ToUserName == this.nowOpenIdData || messages[i].FromUserName == this.nowPhoneNo || messages[i].ToUserName == this.nowPhoneNo){
              ...
              successCallback: () => {
                ...
                if(this.userTsrL.fromType == 2){
                  ...
                  for (let i = 0; i < this.clientListData.length; i ++){
                    this.clientListData[i].chatFlag = ''
                    if(this.userTsrL.fromType == 1){
                      if (this.clientListData[i].OPENID == this.userTsrL.userInfo.openid){
                        this.clientListData[i].className = 'examine'
                        this.clientListData[i].chatFlag = 'start'
                        // console.log(i)
                        this.selectChat(i)
...
//  End If
// End Function
        // this.chat_textarea = JSON.stringify(this.chat_textarea)
        // this.chat_textarea = UnCheckStr(this.chat_textarea)
        // console.log(typeof this.chat_textarea)
        // return false
      ...
      nothingMessage(index) {
        ...
        if (this.mesageList[index].id == undefined || this.mesageList[index].id == '' || this.mesageList[index].id == null){
      ...
      returnBtn(index) {
        ...
        this.returnDxFn({
          ...
          successCallback: (customerKey) => {
            this.iframeNameData = 'http://10.4.211.11/WeChatNestPage.html?customerKey=' + customerKey
          },
          failCallback: () => {
          }
        })
        ...
        if (this.$refs.chat_window_box.scrollTop == 0) {
          ...
          this.getMoreMess({
            ...
            successCallback: () => {
              ...
              for(let i = 0; i < this.$store.getters.getMoreMessage.length; i ++){
                this.$store.getters.getMoreMessage[i].isMe = ''
                this.$store.getters.getMoreMessage[i].IMGURLNOW = this.imgulrNow
                if (this.$store.getters.getMoreMessage[i].ToUserName == this.nowOpenIdData || this.$store.getters.getMoreMessage[i].ToUserName == this.nowPhoneNo){
      ...
      bottomshow(){
          ...
          let interval=setInterval(() =>{
            ...
            count++;
            if(this.$refs.chat_window_box.scrollTop != this.$refs.chat_window_box.scrollHeight){
