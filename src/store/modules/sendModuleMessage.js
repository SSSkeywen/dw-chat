...
const actions = {
    //员工信息编辑
    [types.CLIENT_COMPILE]({ commit }, { tsrcardData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //员工信息编辑
    [types.PISDEFAULT]({ commit }, { pisDefaultData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    [types.TITLELISTDATA]({ commit }, { ValueData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //保存内容
    [types.SAVELISTDATA]({ commit }, { saveList, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //保存内容
    [types.RESTORDATA]({ commit }, { successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //生成二维码
    [types.QRCODELOGION]({ commit }, { bindingData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //获取名片信息
    [types.MODELLIST]({ commit }, { modelListWechat,  successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //模版预览
    [types.SHOWTM]({ commit }, {showtmData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //微信发送
    [types.TEMPWECHAT]({ commit }, { wechataData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //短信发送
    [types.TEMPSMS]({ commit }, { NoteData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //会话开关
    [types.UPDATACHATSTATUS]({ commit }, { unDataChat, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //绑定完成
    [types.TO_LOGION_CKECK]({ commit }, { tsrcodeData,  successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //消息轮训
    [types.MESSAGE_LX]({ commit }, {messageNoData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //消息轮训
    [types.NOTHINGMESSAGE]({ commit }, {toSaveOffData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    //返回列表
    [types.RETURNDX]({ commit }, { returnDxData, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
    ...
    [types.TSRUNBIND]({ commit }, { returnDxData2, successCallback = () => { }, failCallback = () => { } }) {
        axios({
            method: 'post',
