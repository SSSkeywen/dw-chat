                                    ...
                                    <ul>
                                        <li class="new-li-list-two" v-for="(item,index) in cardListData.booksListData" style="margin-left:10px;" :key="index">
                                          ...
                                          <div style="display:flex;display:-webkit-flex;height:40px;" v-else class="new-li-list-two-mengban-two" >
                                            ...
                                            <div style="width:90%;height:40px;" @click="openPlanBooksContent(index,true)"></div>
                                          </div>
                                            <div class="card_checkbox">
      ...
      <div class="booksBg" v-if="isShowBooks">
        <div class="books-content">
            ...
            <div class="books-banner-box">
                ...
                <p class="books-name">{{booksListContent.NAME}}{{booksListContent.sex}}<span class="span-one">您好</span><span class="span-two">{{booksListContent.age}}岁</span></p>
                <div class="books-no">
                    <div>
...
export default {
  ...
  methods: {
    ...
    WechatPreview() {
      if (
        this.listNoThree.isCardSelect == false
      ) {
        return false;
      }
      // let listNoThree = this.selectableListData[this.listOneNo].temlist[
      //   this.listTwoNo
      // ];
      // console.log(this.listNoThree)
      if (
        this.listNoThree.isCardSelect
      ) {
      ...
      this.getJhsMessageFn({
        ...
        successCallback: (result) => {
          ...
          for(let i = 0;i < result.PTS.length; i ++ ){
            ...
            //金额
            result.PREMIUM = (Number(result.PREMIUM)+Number(result.PTS[i].PT.PREMIUM)).toFixed(2)
          ...
          result.DateTime = dateTime.getFullYear()+'-'+monthData+'-'+dateData + ' 00:00:00'
    ...
    openPlanBooksContent(index,isOpenjhs){
        // console.log(this.isSureBooksNo)
        this.selectableListData[this.listOneNo].temlist[this.listTwoNo].booksCode = JSON.stringify(index)
        this.getJhsMessageFntwo()
        if(index == 1){
          // console.log(this.selectableListData[this.listOneNo].temlist[this.listTwoNo])
          this.listNoThree = this.selectableListData[this.listOneNo].temlist[this.listTwoNo].jhs.isCardSelect = true
          this.listNoThree = this.selectableListData[this.listOneNo].temlist[this.listTwoNo].jhs.policyType = this.policyType
    //       this.policyType = '2'
    // this.policyCode = '0100358629'
          this.listNoThree = this.selectableListData[this.listOneNo].temlist[this.listTwoNo].jhs.policyCode = this.policyCode
          this.listNoThree = this.selectableListData[this.listOneNo].temlist[this.listTwoNo].jhs


        }
        if(index == 2){
          this.listNoThree = this.selectableListData[this.listOneNo].temlist[this.listTwoNo].qrs.isCardSelect = true
          this.listNoThree = this.selectableListData[this.listOneNo].temlist[this.listTwoNo].qrs.policyType = this.policyType
          this.listNoThree = this.selectableListData[this.listOneNo].temlist[this.listTwoNo].qrs.policyCode = this.policyCode
          this.listNoThree = this.selectableListData[this.listOneNo].temlist[this.listTwoNo].qrs
        }
        if(index == 0){
          this.listNoThree = this.selectableListData[this.listOneNo].temlist[this.listTwoNo]
        }
